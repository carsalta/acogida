...
/**
 * Normaliza distintas variantes de JSON de entrada
 * Acepta:
 *  A) { visita: [...], contrata: [...] }
 *  B) { questions: { visita: [...], contrata: [...] } }
 *  C) Agrupado por idioma:
 *     { es: { visita:[...], contrata:[...] }, en: { visita:[...], contrata:[...] } }
 *  D) Agrupado por tipo -> idioma:
...
function normalizeImportedQuestions(raw, enabledLangs) {
    ...
    // Caso más común: { visita: [...], contrata: [...] } o arrays
    ...
    // Agrupado por idioma: { es:{ visita:[...], contrata:[...] }, en:{...} }
    ...
    // Agrupado por tipo -> idioma: { visita:{ es:[...], en:[...] }, contrata:{...} }
    const isTypeLang =
    ...
    // Último recurso: si es un array plano, lo colgamos en "visita"
...
/**
 * Validación mínima para no romper la UI
 */
...
export default function QuestionsEditor() {
    ...
    // Lectura del estado actual global
    ...
    const handleFileChange = async (e) => {
        ...
        try {
            ...
            // Limpia input para permitir reimportar el mismo archivo si hace falta
            e.target.value = '';
    ...
    return (
        <div style={{ display: 'grid', gap: 12 }}>
            ...
            {/* Aquí puedes mantener tu editor de items si lo tenías (listas, formularios, etc.) */}
        </div>
    );
} import React, { useMemo, useRef, useState } from 'react';
import { useConfig } from '../hooks/useConfig';
